...
{
    public partial class MovingStopLossControl : UserControl
    {
        ...
        private void btnSendMovingOrder_Click(object sender, EventArgs e)
        {
            ...
            m_nCode = Functions.SendMovingStopLoss(m_UserAccount, strFutureNo, nPeriod, nFlag, nBidAsk, strTriggerPrice, nQty, strMovingPoint, strMessage, out nSiz);

            m_strMessage = strMessage.ToString();

            if (GetMessage != null)
            {
                GetMessage("MovingStopLoss", m_nCode, m_strMessage);
            }
        ...
        private void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            m_nCode = Functions.CancelMovingStopLoss(m_UserAccount, strBookNo, "0", "0", "0", "0", "0", "0", "0", strMessage, out nSiz);

            m_strMessage = strMessage.ToString();

            if (GetMessage != null)
            {
                GetMessage("CancelMovingStopLoss", m_nCode, m_strMessage);
            }
        }
