...
Public Class FutureOrderControl
...
#Region "Custom Method"
    ...
    ' Custom Method
    '----------------------------------------------------------------------
    Public Sub OnOpenInterestCallBack(ByVal OpenInterest As String)
        RaiseEvent GetMessage("OpenInterestReport", 0, OpenInterest)
    End Sub
...
#End Region
    ...
    Private Sub btnSendFutureOrder_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSendFutureOrder.Click
        ...
        m_nCode = Functions.SendFutureOrder(m_UserAccount, strFutureNo, nPeriod, nFlag, nBidAsk, strPrice, _
         nQty, strMessage, nSiz)

        m_strMessage = strMessage.ToString()

        RaiseEvent GetMessage("FutureOrder", m_nCode, m_strMessage)

        strMessage = Nothing

    End Sub

    Private Sub btnSendFutureOrderAsync_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSendFutureOrderAsync.Click
        If m_UserAccount = "" Then
            MessageBox.Show("請選擇期貨帳號")
            Return
        End If
        ...
        m_nCode = Functions.SendFutureOrderAsync(m_UserAccount, strFutureNo, nPeriod, nFlag, nBidAsk, strPrice, _
         nQty)

        RaiseEvent GetMessage("FutureOrderAsync", m_nCode, "")
    ...
    Private Sub btnQuery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnQuery.Click
        ...
        Dim fOpenInterest As New FOnGetBSTR(AddressOf OnOpenInterestCallBack)
        ...
        If m_nCode <> 0 Then
            RaiseEvent GetMessage("GetOpenInterest", m_nCode, "")
        End If
