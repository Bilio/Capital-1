...
Public Class OptionStopLossControl
...
#End Region
    ...
    Private Sub btnSendMovingOrder_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSendMovingOrder.Click
        ...
        m_nCode = Functions.SendOptionStopLoss(m_UserAccount, strFutureNo, nPeriod, nFlag, nBidAsk, strTriggerPrice, _
         nQty, strMovingPoint, strMessage, nSiz)

        m_strMessage = strMessage.ToString()

        RaiseEvent GetMessage("OptionStopLoss", m_nCode, m_strMessage)
    ...
    Private Sub btnCancel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCancel.Click
        ...
        m_nCode = Functions.CancelOptionStopLoss(m_UserAccount, strBookNo, "0", "0", "0", "0", _
         "0", "0", "0", strMessage, nSiz)

        m_strMessage = strMessage.ToString()

        RaiseEvent GetMessage("CancelOptionStopLoss", m_nCode, m_strMessage)
