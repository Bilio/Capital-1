...
#Region "Custom Method"
    ...
    Public Sub OnRealBalanceReportCallBack(ByVal strBalanceReport As String)
        RaiseEvent GetMessage("RealBalanceReport", 0, strBalanceReport)
    End Sub
#End Region
...
#Region "Component Event"
    ...
    Private Sub btnSendStockOrder_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSendStockOrder.Click
        ...
        m_nCode = Functions.SendStockOrder(m_UserAccount, strStockNo, nPeriod, nFlag, nBidAsk, strPrice, _
         nQty, strMessage, nSiz)

        m_strMessage = strMessage.ToString()

        RaiseEvent GetMessage("StockOrder", m_nCode, m_strMessage)

        strMessage = Nothing

    End Sub

    Private Sub btnSendStockOrderAsync_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSendStockOrderAsync.Click
        If m_UserAccount = "" Then
            MessageBox.Show("請選擇證券帳號")
            Return
        End If
        ...
        m_nCode = Functions.SendStockOrderAsync(m_UserAccount, strStockNo, nPeriod, nFlag, nBidAsk, strPrice, _
         nQty)

        RaiseEvent GetMessage("StockOrderAsync", m_nCode, "非同步委託")
    ...
    Private Sub btnDecreaseQty_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDecreaseQty.Click
        ...
        If Integer.TryParse(txtDecreaseQty.Text.Trim(), nQty) Then
            Dim strSeqNo As String = txtDecreaseSeqNo.Text.Trim()
    ...
    Private Sub btnQueryReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnQueryReport.Click
        'Get RealBalanceReport
        Dim fRealBalanceReport As New FOnGetBSTR(AddressOf OnRealBalanceReportCallBack)
        ...
        If m_nCode <> 0 Then
            RaiseEvent GetMessage("GetRealBalanceReport", m_nCode, "")
        End If
