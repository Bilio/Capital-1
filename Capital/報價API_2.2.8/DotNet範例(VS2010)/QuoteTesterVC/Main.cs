...
namespace QuoteTester
{
    public partial class Main : Form
    {
        ...
        FOnNotifyFutureTradeInfo fOnNotifyFutureTradeInfo;
        ...
        private void btnInitialize_Click(object sender, EventArgs e)
        {
            ...
            Functions.SKQuoteLib_AttachFutureTradeInfoCallBack(fOnNotifyFutureTradeInfo);
        ...
        public void OnNotifyFutureTradeInfo(string caStockNo, short sMarket, short sStockidx, int nBuyTotalCount, int nSellTotalCount, int nBuyTotalQty, int nSellTotalQty, int nBuyDealTotalQty, int nSellDealTotalQty)
        {
            lblFutureStockNo.Text = caStockNo;
            lblnBuyTotalCount.Text = nBuyTotalCount.ToString();
            lblnSellTotalCount.Text = nSellTotalCount.ToString();
            lblSellTotalQty.Text = nSellTotalCount.ToString();
            lblnBuyTotalQty.Text = nBuyTotalQty.ToString();
            lblSellTotalQty.Text = nSellTotalQty.ToString();
            lblnBuyDealTotalCount.Text = nBuyDealTotalQty.ToString();
            lblnSellDealTotalCount.Text = nSellDealTotalQty.ToString();
        }
    }
}
